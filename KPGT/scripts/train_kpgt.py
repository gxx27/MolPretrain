...
if __name__ == '__main__':
    ...
    collator = Collator_pretrain(vocab, max_length=config['path_length'], n_virtual_nodes=2)
    ...
    train_dataset = MoleculeDataset(root_path=args.pretrain1_path) # ChemBL and PubChem have the same d_fps and d_mds
